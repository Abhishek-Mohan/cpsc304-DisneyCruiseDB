...
public class ManagerFrm extends JFrame {
	...
	public ManagerFrm() {
		...
		scrollPane.setBounds(15, 15, 1145, 956);
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] {
						"Manager ID ", "Manager Name", "Department", "Cabin ID"
				}
		));
		...
		lblFindCrewBy.setBounds(1314, 247, 231, 21);
...
//					desktopPane.add(mngSchIF);
		...
		btnFindCrewSch.setBounds(1365, 364, 123, 29);
...
//					desktopPane.add(mngSchIF);
		...
		btnNewButton.setBounds(1314, 450, 215, 63);
		...
		btnNewButton_1.setBounds(1314, 587, 215, 81);
